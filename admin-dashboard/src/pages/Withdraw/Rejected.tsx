...
import { setRejectedWithList, Withdraw } from "../../store/slices/withdraw"
...
const Pending = ({ setLoading }: { setLoading: Dispatch<SetStateAction<boolean>> }) => {
    ...
    const { rejectedList } = useSelector((store: RootState) => store.withdraw)
    const getList = async () => {
        try {
            setLoading(true)
            ...
            dispatch(setRejectedWithList(res.data.data.map((witdraw: Withdraw) => ({
                _id: witdraw._id,
            ...
            <div className="w-full overflow-x-auto">
                <Table  >
                    ...
                    <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                        {rejectedList?.map((withdraw: Withdraw) => (
