    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (!isValidPassword(password)) {
                throw new Error('Password must be 8+ chars and include upper, lower, and numbers');
            }
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={styles.form}>
                            ...
                            <View style={styles.fieldGroup}>
                                ...
                                {authMode === 'email' ? (
                                    <View style={[styles.input, styles.inputFlex, styles.phoneInputJoined, styles.inputRow]}>
                                        <TextInput
                                            value={email}
                            ...
                            <View style={styles.fieldGroup}>
                                ...
                                <Text style={styles.helper}>
                                    8+ chars with upper, lower, and numbers
                                </Text>
                                <TouchableOpacity
                            ...
                            <View style={styles.buttonRow}>
                                ...
                                >
                                    ...
                                    <Text style={styles.googleText}>Google Signup</Text>
                                </TouchableOpacity>
