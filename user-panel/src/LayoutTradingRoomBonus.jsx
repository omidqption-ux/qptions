...
import NavbarBonus from './pages/TradingRoomBonus/Components/NavbarBonus'
     ...
     const getUserTradingRoomInfo = async () => {
          try {
               const tradingRoomRes = await axiosInstance.post(
                    '/tradingRoom/setTradingRoomBonus'
               )
          ...
          <Box className='select-none relative flex bg-darkStart'>
               ...
               <AppBar className={`z-0 bg-footerBg`}>
                    ...
                    >
                         ...
                         >
                              <MenuIcon className='text-menuTxt' />
                         </IconButton>
                         <IconButton
                              color='inherit'
                              onClick={(e) => handleChange(e, "Deposit")}
                              className={` lg:ml-14 flex lg:hidden  text-blue-500`}
                         >
                              <DepositIcon fontSize='small' />
                         </IconButton>
                         <NavbarBonus toggleChat={toggleChat} socket={socket} />
                    </Toolbar>
               </AppBar>
               <Drawer
                    variant='permanent'
