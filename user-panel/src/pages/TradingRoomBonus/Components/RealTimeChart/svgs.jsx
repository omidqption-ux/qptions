...
export const prevClockSvgUri = `data:image/svg+xml;utf8,${prevEncodedSvg}`
export const clockNoTimeSvgUriBuy = `data:image/svg+xml;utf8,${encodedClockSvgBuy}`
export const clockNoTimeSvgUriSell = `data:image/svg+xml;utf8,${encodedClockSvgSell}`