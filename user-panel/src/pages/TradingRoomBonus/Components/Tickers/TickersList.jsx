...
const TickersList = ({
     ...
     const setActiveTickerFunction = (symbol, e) => {
          ...
          userSettings.soundControl.notification && playClick()
          dispatch(setActiveTickerBonus(symbol))
     ...
     return (
          <Box className='my-1 w-full'>
               ...
               {tickerType === 'WATCHLIST' &&
                    ...
                    WATCHLISTSymbols.length > 0 && (
                         <div className='flex justify-start w-full'>
                              <Button
                                   className='bg-googleRed text-gray-300 font-semibold text-xs normal-case'
               ...
               <div className='overflow-y-scroll max-h-[140px] xl:max-h-[200px]'>
                    {
                         loading ? (
                                   ...
                                   (cryptoSymbols.length > 0 && (
                                        cryptoSymbols.map((symbol, index) => (
                                             <div
                                                  ...
                                                  key={symbol.symbol + index}
                                             >
                                                  <div className='lg:text-sm text-xs font-normal grid grid-cols-6 gap-2'>
                                                       <div className='col-span-5 flex items-center'>
                                                            {WATCHLISTSymbols &&
                                                                 WATCHLISTSymbols.length > 0 &&
                                                                 WATCHLISTSymbols.findIndex(
                                                                 ...
                                                                 >
                                                                      <StarBorderIcon
                                                                           className='cursor-pointer hover:text-gold text-xs lg:text-sm'
                                                                           onClick={() =>
                                                                                addToWatchListFunction(
                                                                                     symbol
                                                                                )
                                                            ...
                                                            >
                                                                 <span
                                                                      className='cursor-pointer hover:underline text-xs lg:text-sm'
                                                                      onMouseDown={(e) => e.preventDefault()}
                                                                      onClick={(e) => setActiveTickerFunction(symbol, e)
                                                                      }
                                                                 >
                                                  ...
                                                  {index < fxSymbols.length - 1 && (
                                                       <Divider className='bg-DarkBlue my-2' />
                                                  )}
                                             </div>
                                        ))
                                   )
