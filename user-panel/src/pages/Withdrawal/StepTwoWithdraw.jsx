...
const StepTwoWithdraw = ({ handleNext }) => {
     const dispatch = useDispatch()
     const [currencyLoading, setCurrencyLoading] = React.useState(false)
     const { paymentMethods } = useSelector((store) => store.withdraw)
     ...
     const getCurrencies = async () => {
          try {
               ...
               dispatch(setPaymentMethods(coinsRes.currencies))
          } catch (e) {
...
export default StepTwoWithdraw
