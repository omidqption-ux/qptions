                    ...
                    >
                         <div className="w-full max-w-7xl px-4">
                              ...
                              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
                                   <Link href="/technical-analysis" className="text-green-500 hover:text-green-400 transition-colors duration-300 flex items-center gap-2">
                                        ...
                                        <div className="space-y-4">
                                             {how.map((item, idx) => (
                                                  <div key={idx} className="flex items-start gap-3">
                                                       <span className="text-green-200 mt-1">{idx + 1}.</span>
                                                       <div>
