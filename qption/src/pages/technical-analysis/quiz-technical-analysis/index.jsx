...
export default function TechnicalQuizPage() {
    const { t: tq, i18n } = useTranslation('technicalQuiz')
    ...
    if (!pool.length) {
        return (
            <>
                ...
                <SEOAlternates />
                <main dir={isRTL ? 'rtl' : 'ltr'} className="bg-linear-to-b from-[#142B47] to-[#142B47]/90 w-full flex items-center justify-center p-6 min-h-screen">
    ...
    return (
        <>
            ...
            <main dir={isRTL ? 'rtl' : 'ltr'} className="bg-linear-to-b from-[#142B47] to-[#142B47]/90 w-full flex flex-col items-center justify-start p-4 lg:p-12 min-h-screen">
                {/* Hero */}
                <motion.div
    ...
    return {
        props: {
            ...(await serverSideTranslations(
                locale,
                ['common', 'nav', 'footer', 'auth', 'technicalQuiz'],
                i18nConfig
            )),
        },
    }
